...
If you want some [isolation]({{ '/tasks/manage/application-isolation' | relative_url }}), you
...
container, for example:
    ...
    host1$ docker run -e WEAVE_CIDR=net:10.2.7.0/24 -ti alpine:latest
...
for instance:
    ...
    host1$ docker run -e WEAVE_CIDR="net:10.2.7.0/24 net:10.2.8.0/24 ip:10.3.9.1/24" -ti alpine:latest
